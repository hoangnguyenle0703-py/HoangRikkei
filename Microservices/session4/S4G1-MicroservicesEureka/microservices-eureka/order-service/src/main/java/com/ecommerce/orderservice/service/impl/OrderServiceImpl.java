...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponseDTO create(OrderRequestDTO request) {
        ...
        // Lấy giá sản phẩm từ Product Service (qua Eureka), rồi tính totalAmount
    ...
    @Override
    public ProductInfo getProductFromProductService(Long productId) {
        // Gọi sang Product Service hoàn toàn qua Eureka, không dùng URL cứng
